// Copied this from https://github.com/eugeneware/ffprobe
// At the time because that package didn't include the 'format' output using the flag '-show_format'.
// So I copied it so I can add it myself.
